...
function printHelp(): void {
  console.log([
    ...
    '',
    'Task Actions:',
        '  create --id <id> --title <title> [--type task|initiative|milestone|goal] [--parent <id>] [--due YYYY-MM-DD] [--icon emoji] [--subtitle <s>]',
        ...
        '  update <id> --field <name> [--value <v>]   Generic field setter (allowlist: title, subtitle, icon, dueDate for tasks; title, unit, source, icon for kpis). Reports current value if --value omitted.',
    ...
    '  publish [--project <name>]            Publish the static dashboard to Cloudflare Pages',
  '                                         --project <name>: change the Cloudflare Pages project name (updates .milestr-cloudflare.json, creates the project if missing, warns if URL will change)',
    '',
    'Examples:',
